...
public static class ProjectMicrosserveicesAbpEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ProjectMicrosserveicesAbpModuleExtensionConfigurator CLASS (in the Domain.Shared project)
